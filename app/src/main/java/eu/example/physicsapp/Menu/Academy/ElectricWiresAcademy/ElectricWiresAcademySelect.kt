package eu.example.physicsapp.Menu.Academy.ElectricWiresAcademy
...
@Composable
fun AccademyElectricWiresSelect(navController: NavController){
    Scaffold(
        topBar = {
        ...
        LazyColumn(
            ...
            val chapters = listOf(
                Chapter("Lekcja 1", "Jak zbudowany jest przewód", "O tym jak i dlaczego zbudowane są przewody.","startActivity"),
                Chapter("Lekcja 2", "Żyła przewodu", "O materiałach, przekrojach i właściwościach żył","startActivity"),
