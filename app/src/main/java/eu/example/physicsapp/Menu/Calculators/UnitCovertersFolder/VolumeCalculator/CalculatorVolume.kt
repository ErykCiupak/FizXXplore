...
@Composable
fun CalcVolume(navController: NavController,viewModel: SharedViewModel){

    //Resetowanie zmiennych po wejsciu ponownie
    fun tylkoRaz(){
        viewModel.updateSelectedUnitName("metr sześcienny")
        viewModel.upadateSelectedUnitExts("m³")
        viewModel.inputNumber = ""
        volumeConverter(viewModel)
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            val listOfOutput = listOf(
                OutputData("metr sześcienny", viewModel.outPutNumberM3, "m³", viewModel),
                OutputData("litr", viewModel.outPutNumberL, "L", viewModel),
                OutputData("baryłka amerykańska", viewModel.outPutNumberBbl, "bbl", viewModel),
                OutputData("centymetr sześcienny", viewModel.outPutNumberCm3, "cm³", viewModel),
                OutputData("stopa sześcienna", viewModel.outPutNumberFt3, "ft³", viewModel),
                OutputData("galon brytyjski", viewModel.outPutNumberGalB, "gal GB", viewModel),
                OutputData("galon amerykański", viewModel.outPutNumberGalU, "gal US", viewModel),
                OutputData("cal sześcienny", viewModel.outPutNumberIn3, "in³", viewModel),
    ...
    if (viewModel.isSheetOpen){
        ModalBottomSheet(
            ...
            val listOfOutput = listOf(
                UnitData("metr sześcienny","m³",viewModel,"volume"),
                UnitData("litr","L",viewModel,"volume"),
                UnitData("baryłka amerykańska","bbl",viewModel,"volume"),
                UnitData("centymetr sześcienny","cm³",viewModel,"volume"),
                UnitData("stopa sześcienna","ft³",viewModel,"volume"),
                UnitData("galon brytyjski","gal GB",viewModel,"volume"),
                UnitData("galon amerykański","gal US",viewModel,"volume"),
                UnitData("cal sześcienny","in³",viewModel,"volume"),
