...
@Composable
fun CalcDensity(navController: NavController,viewModel: SharedViewModel){

    //Resetowanie zmiennych po wejsciu ponownie
    fun tylkoRaz(){
        viewModel.updateSelectedUnitName("kilogram na metr sześcienny")
        viewModel.upadateSelectedUnitExts("kg/m³")
        viewModel.inputNumber = ""
        densityConvert(viewModel)
    }
    ...
    Scaffold(
        ...
        Column(
            ...
            val listOfOutput = listOf(
                OutputData("kilogram na metr sześcienny", viewModel.outPutNumberKgm3, "kg/m³", viewModel),
                OutputData("gram na mililitr", viewModel.outPutNumberGml, "g/ml", viewModel),
                OutputData("funt na stopę sześcienną", viewModel.outPutNumberLbft, "lb/ft³", viewModel),
                OutputData("funt na cal sześcienny", viewModel.outPutNumberLbin, "lb/in³", viewModel),
            )
            LazyColumn(
    ...
    if (viewModel.isSheetOpen){
        ModalBottomSheet(
            ...
            val listOfOutput = listOf(
                UnitData("kilogram na metr sześcienny","kg/m³",viewModel,"density"),
                UnitData("gram na mililitr","g/ml",viewModel,"density"),
                UnitData("funt na stopę sześcienną","lb/ft³",viewModel,"density"),
                UnitData("funt na cal sześcienny","lb/in³",viewModel,"density"),
            )
            LazyColumn(
                modifier = Modifier.fillMaxSize(),
                horizontalAlignment = Alignment.CenterHorizontally,
