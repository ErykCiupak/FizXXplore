package eu.example.physicsapp.Menu.Academy.ElectricElements
...
@Composable
fun ElectricElementsSelect(navController: NavController){
    Scaffold(
        topBar = {
        ...
        LazyColumn(
            ...
            val chapters = listOf(
                Chapter("Lekcja 1", "Rezystor", "O budowie, parametrach i zastosowaniu rezystorów.","startActivity"),
                Chapter("Lekcja 2", "Kondensator", "O budowie, parametrach i zastosowaniu kondensatorów.","startActivity"),
