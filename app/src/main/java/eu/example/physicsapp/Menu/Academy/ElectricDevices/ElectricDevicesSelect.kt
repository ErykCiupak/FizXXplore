package eu.example.physicsapp.Menu.Academy.ElectricDevices
...
@Composable
fun AccademyElectricDevicesSelect(navController: NavController){
    Scaffold(
        topBar = {
        ...
        LazyColumn(
            ...
            val chapters = listOf(
                Chapter("Lekcja 1", "Klasy ochronności", "O ochronie przed porażeniem elektrycznym.","startActivity"),
                Chapter("Lekcja 2", "Stopnie ochrony IP i IK", "O ochronie urządzeń przed szkoliwym działaniem środowiska i oddziaływaniami mechanicznymi.","startActivity"),
