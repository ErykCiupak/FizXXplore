package eu.example.physicsapp.Menu.Academy.Battery
...
@Composable
fun AccademyBatterySelect(navController: NavController){
    Scaffold(
        topBar = {
        ...
        LazyColumn(
            ...
            val chapters = listOf(
                Chapter("Lekcja 1", "Ogniwo cynkowo-węgloww", "Protoplasta współcześnie znanych baterii.","startActivity"),
                Chapter("Lekcja 2", "Ogniwo alkaliczne", "Najpopularniejsze ogniwa XX wieku.","startActivity"),
