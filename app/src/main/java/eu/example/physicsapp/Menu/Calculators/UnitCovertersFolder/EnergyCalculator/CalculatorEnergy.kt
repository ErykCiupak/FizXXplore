...
@Composable
fun CalcEnergy(navController: NavController,viewModel: SharedViewModel){

    //Resetowanie zmiennych po wejsciu ponownie
    fun tylkoRaz(){
        viewModel.updateSelectedUnitName("dżul")
        viewModel.upadateSelectedUnitExts("J")
        viewModel.inputNumber = ""
        energyConvert(viewModel)
    }
...
//                        navController.popBackStack()
        ...
        Column(
            ...
            val listOfOutput = listOf(
                OutputData("dżul", viewModel.outPutNumberJ, "J", viewModel),
                OutputData("kilodżul", viewModel.outPutNumberKJ, "kJ", viewModel),
                OutputData("watogodzina", viewModel.outPutNumberWh, "Wh", viewModel),
                OutputData("kilowatogodzina", viewModel.outPutNumberKWh, "kWh", viewModel),
                OutputData("kaloria", viewModel.outPutNumberCal, "cal", viewModel),
                OutputData("kilokaloria", viewModel.outPutNumberKcal, "kcal", viewModel),
                OutputData("elektronowolt", viewModel.outPutNumberEV, "eV", viewModel),
                OutputData("brytyjska jednostka ciepła", viewModel.outPutNumberBTU, "BTU", viewModel)
                )
            LazyColumn(
    ...
    if (viewModel.isSheetOpen){
        ModalBottomSheet(
            ...
            val listOfOutput = listOf(
                UnitData("dżul","J",viewModel,"energy"),
                UnitData("kilodżul","kJ",viewModel,"energy"),
                UnitData("watogodzina","Wh",viewModel,"energy"),
                UnitData("kilowatogodzina","kWh",viewModel,"energy"),
                UnitData("kaloria","cal",viewModel,"energy"),
                UnitData("kilokaloria","kcal",viewModel,"energy"),
                UnitData("elektronowolt","eV",viewModel,"energy"),
                UnitData("brytyjska jednostka ciepła","BTU",viewModel,"energy"),
